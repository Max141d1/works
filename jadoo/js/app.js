(() => {
    ...
    const elementCard = document.querySelector(".ongoing-card");
    const cardAction = document.querySelector(".footer-card__favorite");
    cardAction.addEventListener("mouseover", (function(event) {
        elementCard.classList.add("card-active");
    }));
    cardAction.addEventListener("mouseout", (function(event) {
        elementCard.classList.remove("card-active");
    }));
    cardAction.addEventListener("click", (function(event) {
        elementCard.classList.toggle("card-active");
    }));
    if (window.matchMedia("(max-width: 490.98px)").matches) {
        const menuTitles = document.querySelectorAll(".menu-footer__title");
