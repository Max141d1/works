...
***************************************************************************** */
        ...
        menuLinks.forEach((function(link) {
            link.addEventListener("click", (function(event) {
                ...
                const otherLinks = document.querySelectorAll(".menu__link");
                otherLinks.forEach((function(otherLink) {
                    if (otherLink !== link) otherLink.classList.remove("menu__link--active");
                }));
                localStorage.setItem("activeMenuLink", link.getAttribute("href"));
            }));
        }));
        const activeLink = localStorage.getItem("activeMenuLink");
        if (activeLink) {
            const activeMenuLink = document.querySelector('.menu__link[href="' + activeLink + '"]');
            if (activeMenuLink) activeMenuLink.classList.add("menu__link--active");
        }
